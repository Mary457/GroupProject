...
public class ParkingTicket {
    ...
    public double getDurationHours() {
        ...
        return Math.max(0.5, Math.ceil(hours * 2) / 2); // Round up to nearest 0.5 hour, minimum 0.5
    }
    ...
    public boolean isExpired() {
        ...
        return hours > 24; // Expires after 24 hours
    }

    public double calculateLateFee() {
        if (!isExpired()) return 0.0;
        long hoursOver = (getDurationMinutes() / 60) - 24;
        return hoursOver * 10.0; // $10 per hour late fee
    }
